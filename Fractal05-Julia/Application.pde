class Application {
  private Integer SIZE_I, SIZE_J; // largeur et hauteur de la fenêtre en pixels
  ...
  private Double minX; // minimum des x (variables intermédiaires à ne pas modifier)
  private Double rangeX; // domaine des x (variables intermédiaires à ne pas modifier)
  private Double rangeY; // domaine des y (variables intermédiaires à ne pas modifier)
  private Double minY; // minimum des y (variables intermédiaires à ne pas modifier)
  private Scene currentScene; // objet scene (variables intermédiaires à ne pas modifier)
  ...
  public Application(Integer sizeI, Integer sizeJ) {
    ...
    minX = (double) -1.0;
    rangeX = (double) 2.0;
    rangeY = (double) rangeX*SIZE_J/SIZE_I;
    minY = (double) -rangeY/2;
    currentScene = new Scene(minX, minY, rangeX, rangeY, trans, angle, agr);
  }
